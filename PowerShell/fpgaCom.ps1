...
$writestreamreader = New-Object System.IO.StreamReader("C:\Users\ryanm\Desktop\writeFile.txt")
$lineerror = 0
...
#Reads and writes over COM port
while(($linewrite = $writestreamreader.ReadLine()) -ne $null)
{
    #Write-Host("line value: " + $linewrite)
